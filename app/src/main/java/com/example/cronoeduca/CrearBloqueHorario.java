...
public class CrearBloqueHorario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crear_bloque_horario);
        ...
        UsuarioSQLiteOpenHelper database = new UsuarioSQLiteOpenHelper(this);
        t = new Task();
        ...
        if (getIntent().hasExtra("Task")) {
            ...
            background.setColor(t.getColorID(CrearBloqueHorario.this));
